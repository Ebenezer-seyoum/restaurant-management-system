...
export const brand = {
  ...
  address: "Bishoftu Sunshine, beside Yatu Hotel, Oromia Bank building",
...
export const homeSettings = {
  ...
  headerTitle: "EMRAKEL",
  eyebrow: "Bishoftu burger, pizza and cocktail house",
  headline: "EMRAKEL Burger, Pizza & Cocktail House",
  description:
    "A modern restaurant in Bishoftu Sunshine serving burgers, pizza, cocktails, juices, coffee, and relaxed dine-in meals.",
...
export const seoSettings = {
  title: "EMRAKEL | Burger, Pizza & Cocktail House in Bishoftu",
  tabTitle: "EMRAKEL",
  description:
    "EMRAKEL Burger, Pizza & Cocktail House is a modern restaurant in Bishoftu Sunshine beside Yatu Hotel. Enjoy burgers, pizza, cocktails, juices, coffee, dine-in meals, table booking, and our online menu.",
  siteUrl: "https://httpemrakelhouse.com",
  menuUrl: "https://httpemrakelhouse.com/menu",
  image: "/logo.png",
  logo: "/logo.png",
  favicon: "/logo.png",
  appleIcon: "/logo.png",
  keywords: "EMRAKEL, Bishoftu restaurant, burgers, pizza, cocktails, coffee, juices, Yatu Hotel",
  schemaName: "EMRAKEL Burger, Pizza & Cocktail House",
  schemaType: "Restaurant",
  schemaDescription:
    "EMRAKEL Burger, Pizza & Cocktail House is a modern restaurant in Bishoftu Sunshine beside Yatu Hotel, located in the Oromia Bank building.",
  cuisine: "Burgers, Pizza, Cocktails, Sandwiches, Shawarma, Shakes, Mojito",
  priceRange: "$$",
  searchActionEnabled: false,
  sameAs: "",
  sitelinks: [
    { id: "home", label: "Home", title: "EMRAKEL Burger, Pizza & Cocktail House", url: "/", description: "Visit EMRAKEL in Bishoftu Sunshine beside Yatu Hotel for burgers, pizza, cocktails, coffee, and relaxed dine-in meals.", enabled: true, noindex: false },
    { id: "menu", label: "Menu", title: "EMRAKEL Menu", url: "/menu", description: "View the live EMRAKEL menu with burgers, pizza, sandwiches, shawarma, drinks, cocktails, shakes, and current prices.", enabled: true, noindex: false },
    { id: "burgers", label: "Burgers", title: "Burgers at EMRAKEL", url: "/menu?type=burgers", description: "Explore EMRAKEL burger options and live prices from the online menu.", enabled: true, noindex: false },
    { id: "pizza", label: "Pizza", title: "Pizza at EMRAKEL", url: "/menu?type=pizza", description: "Explore EMRAKEL pizza options and live prices from the online menu.", enabled: true, noindex: false },
    { id: "drinks", label: "Drinks", title: "Drinks and Cocktails at EMRAKEL", url: "/menu?type=drinks", description: "Browse EMRAKEL drinks, cocktails, shakes, mojito, coffee, and refreshments.", enabled: true, noindex: false },
    { id: "gallery", label: "Gallery", title: "EMRAKEL Gallery", url: "/gallery", description: "See EMRAKEL interior photos, food moments, and the restaurant atmosphere in Bishoftu.", enabled: true, noindex: false },
    { id: "about", label: "About", title: "About EMRAKEL", url: "/about", description: "Learn about EMRAKEL Burger, Pizza & Cocktail House in Bishoftu Sunshine.", enabled: true, noindex: false },
    { id: "contact", label: "Contact", title: "Contact EMRAKEL", url: "/contact", description: "Find EMRAKEL address, phone, opening hours, and contact details.", enabled: true, noindex: false },
    { id: "book-table", label: "Book Table", title: "Book a Table at EMRAKEL", url: "/book-table", description: "Reserve a table at EMRAKEL. Hide this from Google if booking is only handled by the header dropdown.", enabled: false, noindex: true }
  ],
  searchConsoleUrls: "https://httpemrakelhouse.com\nhttps://httpemrakelhouse.com/menu\nhttps://httpemrakelhouse.com/about\nhttps://httpemrakelhouse.com/gallery\nhttps://httpemrakelhouse.com/contact",
  sitemapUrl: "https://httpemrakelhouse.com/sitemap.xml",
  robotsUrl: "https://httpemrakelhouse.com/robots.txt"
};
...
export const bookingPageSettings = {
  ...
  headline: "Reserve a table at EMRAKEL.",
  description: "Call us or send a table booking request for dine-in meals at EMRAKEL Burger, Pizza & Cocktail House.",
