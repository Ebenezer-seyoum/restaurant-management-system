...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton ref={ref} className={cn("ui-select-scroll", className)} {...props}>
    <ChevronUp size={15} />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton ref={ref} className={cn("ui-select-scroll", className)} {...props}>
    <ChevronDown size={15} />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label ref={ref} className={cn("ui-select-label", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator ref={ref} className={cn("ui-select-separator", className)} {...props} />
));
